  ...
  return (
    <div className="page" id="about">
      ...
      <p className="intro">
        ...
        technology was ignited in elementary school when I played The Oregon
        Trail on an IBM computer, since that day I have always yearned to
        deconstruct and improve software in computers. I'm always eager to take
