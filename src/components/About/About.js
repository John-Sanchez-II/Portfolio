  ...
  return (
    ...
    <div className="page" id="about">
      ...
      <p className="intro">
        ...
        technology was ignited in elementary school while waiting my turn to use
        the one computer in the classroom, and wondering how it worked. since
        that day I have always yearned to deconstruct and improve software in
        computers. I'm always eager to take on more difficult roles in the
        workplace, Furthermore I try to consider others perspectives to get a
